class TabLink {
  constructor(element) {
    ...
    // Add a click event listener on this instance, calling the select method on
    // click
  ...
  select() {
    ...
    // from all of the links Array.from(links).forEach();
...
- Select all classes named ".tabs-link" and assign that value to the links
  variable
...
- In your .forEach() method's callback function, return a new instance of
  TabLink and pass in each link as a parameter
